from lightning_pretraining import C2AELightning
from freeze_pretraining import *
...
c2ae = C2AELightning(image_train.num_classes(), learning_rate=configuration['lr'],
                     architecture=configuration['architecture'], val_dataset=image_val)
