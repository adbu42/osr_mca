...
show_image(train_features[0], image_dataset)
show_image(train_features[1], image_dataset)
show_image(train_non_match_features[0], image_dataset)
show_image(train_non_match_features[1], image_dataset)
